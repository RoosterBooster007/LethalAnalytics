...
namespace LethalAnalytics
{
    public static class AnalyticsManager
    {
        ...
        /// <param name="modDesc">A short description for your mod. Please explain what data/events you wish to collect AND WHY you'll be collecting them. NEVER collect PID or otherwise private info. Please be transparent and respect user privacy. Make the Lethal Company modding community proud!</param>
